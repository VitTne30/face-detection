...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 23, 2023 at 05:52 AM
...
(54, 11, '6441', '2023-12-21 08:23:25', 1, 'momo', 3);
...
(10, 'Bàn phím cơ Asus ROG Azoth', 'b001', 1, 1090000, 9983, '1695234856_banphim1webp.webp', 'Hãng sản xuất: Akko \r\n\r\nTình trạng: Mới\r\n\r\nBảo hành: 12 Tháng\r\n\r\nSwitch: Akko CS switch (Wine Red / Wine White)', 'Hãng sản xuất: Akko \r\n\r\nTình trạng: Mới\r\n\r\nBảo hành: 12 Tháng\r\n\r\nSwitch: Akko CS switch (Wine Red / Wine White)', 1),
(11, 'Bàn phím cơ AKKO 5075B Plus Black&Cyan ', 'b002', 1, 2399000, 9997, '1696015253_banphim2webp.webp', '<p>H&atilde;ng sản xuất: Akko T&igrave;nh trạng: Mới Bảo h&agrave;nh: 12 Th&aacute;ng Switch: Akko Wine Red</p>\r\n', '<p>H&atilde;ng sản xuất: Akko T&igrave;nh trạng: Mới Bảo h&agrave;nh: 12 Th&aacute;ng Switch: Akko Wine Red</p>\r\n', 1),
(12, 'Bàn phím MonsGeek M1 QMK Black ', 'b003', 1, 1390000, 9998, '1696015274_banphim3.webp', '<p>H&atilde;ng sản xuất: Akko T&igrave;nh trạng: Mới Bảo h&agrave;nh: 12 Th&aacute;ng Switch: AKKO Cream Yellow Pro</p>\r\n', '<p>H&atilde;ng sản xuất: Akko T&igrave;nh trạng: Mới Bảo h&agrave;nh: 12 Th&aacute;ng Switch: AKKO Cream Yellow Pro</p>\r\n', 1),
...
(21, 'KTT Kang White Switch', 'PVN1369', 2, 4000, 10000, '1695226898_sw2.webp', 'Thương hiệu: Gateron', 'Thương hiệu: Gateron', 1),
...
(2, 'vanh', 'Việt Anh Phạm', 'vanhpham3009@gmail.com', 'hanoi', '3009', '309'),
(6, '123', '123', '123', '123', '123', '123'),
(10, 'asd', 'Việt Anh', 'vanhpham3009@gmail.com', 'asd', 'asd', 'asd'),
(11, '1', 'Phạm Việt Anh', 'vanhpham3009@gmail.com', '1', '1', '1'),
(14, '2', '2', '2', '2', '2', '2');
...
--
ALTER TABLE `tbl_chitietdonhang`
  MODIFY `id_chitietdonhang` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=82;
...
--
ALTER TABLE `tbl_giohang`
  MODIFY `id_giohang` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=55;
...
--
ALTER TABLE `tbl_momo`
  MODIFY `id_momo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;
